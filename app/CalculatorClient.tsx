      ...
      <div className="relative max-w-5xl mx-auto space-y-8 z-10 print:hidden">
        ...
        <div className="flex flex-col items-center justify-center text-center border-b border-slate-800/80 pb-6 gap-3">
          <span className="inline-flex items-center gap-1.5 text-xs bg-blue-500/10 text-cyan-400 px-3 py-1 rounded-full border border-cyan-500/20 font-medium backdrop-blur-md shadow-sm">
            🏗️ Engineering Standard Estimator
          </span>

          <h3 className="text-4xl md:text-5xl font-extrabold tracking-tight drop-shadow-sm text-white">
            Nirman <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-cyan-400 to-teal-300">AI</span> Material Calculator
          </h3>

          <p className="text-slate-400 text-sm max-w-md">
            Accurate construction material estimates for brickwork, concrete slabs, and steel rebars.
          </p>

          <p className="text-xs text-slate-500 italic">
            Calculated as per <span className="text-cyan-400 font-semibold">BNBC & ACI</span> structural standards.
          </p>
        </div>

        {/* 3. Clean Fixed Responsive Navigation */}
        <div className="relative">
          {/* 🖥️ ডেস্কটপ নেভিগেশন (md এবং বড় স্ক্রিনের জন্য) */}
          ...
          {/* 📱 মোবাইল নেভিগেশন (ছোট স্ক্রিনের জন্য) */}
